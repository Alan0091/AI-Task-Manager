...
const App = () => {
  ...
  const badWords = ['Loda', 'Lavda','Fuck','Dick', 'Lomda', 'Lund', 'Pussy', 'Chut', 'Ass', 'Gaand', 'Anal', 'Bund', 'Fuddi', 'Chudai', 'Chudayi', 'Madarchod', 'Bsdk', 'Bsdka', 'Bhosadi', 'BKL', 'MKC', 'Jhantu', 'Jhant', 'Tatte', 'Aand', 'Chutiya', 'Asshole', 'Motherfucker', 'Bitch', 'Tatti', 'Behanchod', 'Behenchod', 'Chodu', 'Bhosada', 'Blowjob', 'Handjob']
